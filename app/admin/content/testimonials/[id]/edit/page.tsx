...
import { UpdateTestimonialData } from "@/lib/api/testimonials"
...
export default function EditTestimonialPage({ params }: EditTestimonialPageProps) {
  ...
  const { testimonial, loading, error, update, uploadPhoto, delete: deleteTestimonial } = useTestimonial(params.id)
  ...
  // Update form when testimonial data loads
  useEffect(() => {
    if (testimonial) {
      form.reset({
        ...
        projectType: testimonial.projectType as "electrical" | "hvac" | "refrigeration" | undefined,
        isVisible: testimonial.isVisible,
        isFeatured: testimonial.isFeatured,
      })
      setCustomerPhoto(testimonial.customerPhoto || "")
    }
  }, [testimonial, form])
  ...
  const onSubmit = async (data: TestimonialFormData) => {
    try {
      ...
      const updatedTestimonial = await update(params.id, updateData)
      if (updatedTestimonial) {
        router.push("/admin/content/testimonials")
      }
    } catch (error) {
      form.setError('root', { message: 'Failed to update testimonial' })
    }
  }
  ...
  const handleDelete = async () => {
    ...
    if (window.confirm(`Are you sure you want to delete the testimonial from ${testimonial.customerName}? This action cannot be undone.`)) {
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-gray-900">Edit Testimonial</h1>
            <p className="text-gray-600 mt-1">Loading testimonial details...</p>
          </div>
        </div>
        <Card>
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-gray-900">Edit Testimonial</h1>
            <p className="text-gray-600 mt-1">Error loading testimonial</p>
          </div>
        </div>
        <Card>
          <CardContent className="p-6">
            <EmptyState
              ...
              description={error || "The testimonial you're looking for doesn't exist or has been deleted."}
              action={
                <Button onClick={() => router.push("/admin/content/testimonials")}>
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-gray-900">Edit Testimonial</h1>
            <p className="text-gray-600 mt-1">Update testimonial from {testimonial.customerName}</p>
          </div>
        </div>
        <Button
          variant="destructive"
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Update the customer's details and contact information
                  </CardDescription>
                </CardHeader>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Update the customer's testimonial and feedback
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <FormField
